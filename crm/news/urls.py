...
urlpatterns = [
    ...
    path('unpublished/',
        views.UnpublishedNewsListView.as_view(),
        name="unpublished"),
    path('upload/file', views.post_file, name="createfile"),
    path('knowledge/',
        views.KnowledgeCategoryListView.as_view(),
        name="knowledge"),
    ...
    path('QandA/unanswered',
         views.UnansweredQuestionListView.as_view(), name="unanQandA"),
    path('upload/<int:pk>/updatequestion',
         views.answer_question, name="answerqna"),
