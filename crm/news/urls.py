...
urlpatterns = [
    ...
    path('news/unpublished/',
         views.UnpublishedNewsListView.as_view(), name="unpublished"),
    path('knowledge/', views.KnowledgeCategoryListView.as_view(), name="knowledge"),
    path('knowledge/<int:pk>', views.KnowledgeCategoryDetailView.as_view(),
    ...
    path('upload/<int:pk>/updatequestion',
         views.UpdateDocQuestionView.as_view(), name="answerfaq"),
    path('upload/<int:pk>/updatenews',
         views.UnpublishedNewsUpdateView.as_view(), name="updatenews"),
    ...
    path('faq/pending/', views.UnansweredQuestionListView.as_view(),
         name="pending_faq"),
